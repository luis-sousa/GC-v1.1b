 ...
 */
public class AddOrcamentoPT1 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/AddOrcamentoPT1.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Gestão de Orçamentos - Passo 1 de 4");
