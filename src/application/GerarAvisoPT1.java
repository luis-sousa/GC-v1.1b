 ...
 */
public class GerarAvisoPT1 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/GerarAvisoPT1.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Escolha do orcamento");
