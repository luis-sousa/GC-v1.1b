 ...
 */
public class AddOrcamentoPT2 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/AddOrcamentoPT2.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Gestão de Orçamentos - Passo 2 de 4");
