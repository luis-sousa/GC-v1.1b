 ...
 */
public class AddOrcamentoPT3 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/AddOrcamentoPT3.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Gestão de Orçamentos - Passo 3 de 4");
