 ...
 */
public class DespesaPT2 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/DespesaPT2.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Mapa de Despesas");
