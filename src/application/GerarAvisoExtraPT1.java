 ...
 */
public class GerarAvisoExtraPT1 extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/application/GerarAvisoExtraPT1.fxml"));
        Scene scene = new Scene(root);
        stage.setTitle("Escolha do Sub Orçamento");
        ...
        //definir stage
        GerarAvisoExtraPT1.stage = stage;
    }
