...
/**
 * Classe VerAvisoControllerPT1 está responsável pelo controlo dos eventos
 * relativos á Stage que permite escolher um Orçamento para que em seguida possa
 * seguir para a Stage de ver Avisos (VerAvisoControllerPT2)
 *
 * @author Luís Sousa - 8090228
 */
public class VerAvisoControllerPT1 implements Initializable {
    ...
    /**
     * Método que permite ir para a stage seguinte onde se pode ver os avisos de
     * débito já gerados
     *
     * @param event evento
    ...
    private void btNextFired(ActionEvent event) throws ClassNotFoundException, SQLException, Exception {
        new VerAvisoControllerPT2().setIdOrc(getIdOrcamentoSel());
        VerAvisoPT1.getStage().close();
        new VerAvisoPT2().start(new Stage());
    }
    ...
    /**
     * Prepara a tabela fazendo o binding entre as colunas da tabela e o
     * atributo do objeto correspondente
     */
    ...
    /**
     * Inicia a classe VerAvisoControllerPT1
     *
     * @param url url
