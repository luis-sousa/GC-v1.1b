...
/**
 * Esta classe permite converter um numero para extenso.
 *
 * @author Luís Sousa - 8090228
 */
public final class NumeroPorExtenso {
    ...
    /**
     * Construtor da classe NumeroPorExtenso
     *     
* @param dec valor para colocar por extenso
    ...
    /**
     * Constructor da classe NumeroPorExtenso
     *     
* @param dec valor para colocar por extenso
     */
...
// Converte para inteiro arredondando os centimos
        num = dec
...
* @param args numero a ser convertido
    ...
    public static void main(String[] args) {
        ...
        float number = 1.54f;
        NumeroPorExtenso teste = new NumeroPorExtenso(new BigDecimal(number));
        //System.out.println("Numero : " + (new DecimalFormat().format(Double.valueOf(number))));
